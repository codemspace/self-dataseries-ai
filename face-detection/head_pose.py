...
class MarkDetector:
    ...
    def __init__(self, saved_model='models/pose_model'):
        ...
        # Restore model from the saved_model file using TFSMLayer.
        self.model = keras.layers.TFSMLayer(saved_model, call_endpoint='serving_default')
